...
public:
	...
	LayeredMaterial(const ParamSet &mp, std::shared_ptr<Material> &m1,
		 std::shared_ptr<Material> &m2,std::shared_ptr<Material> &m3,
...
private:
	...
	std::shared_ptr<Texture<float> > opacity1,opacity2,opacity3,opacity4;
};
