...
/**
 * This texture provides texture subtraction. This can be used, for example, to remove
 * a certain amount of red to a texture and make it shift color tone.
 */
...
// SubtractTexture Method Definitions
